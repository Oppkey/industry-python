...
Full free course called [Industry Projects with Python](https://industry-python.thinkific.com/products/courses/industry-projects-with-python) covers Python iterables and much more. Full code for each section is available for download.
